...
import { StyleSheet, View, Image, ActivityIndicator, PermissionsAndroid, Platform, Text } from 'react-native';
...
const MediaScreen: FC<any>=({ route, navigation }) => {
  ...
  return (
    <View style={styles.container}>
      {type === 'photo' && (
        <>
          <Text style={{color: 'red'}}>asdfsadf{source.uri}</Text>
